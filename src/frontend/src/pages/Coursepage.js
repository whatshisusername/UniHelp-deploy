                    ...
                    <ul>
                        {notes.map((note) => (
                            <li key={note._id} className="flex justify-between items-center py-2 border-b">
                                <div>
                                    <p className="text-lg">{note.filename}-<a href={note.notesfile} target="_blank" className="bg-blue-200 hover:bg-grey text-blue-500 font-bold py-2 px-4 rounded inline-flex items-center"><svg className="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg>
